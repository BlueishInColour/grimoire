...
void main() async {
  ...
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider<PublishController>(
        create: (_) => PublishController()),
    ChangeNotifierProvider<StoryViewerUiController>(
        create: (_) => StoryViewerUiController()),
    ChangeNotifierProvider<InAppPurchaseUtils>(
        create: (_) => InAppPurchaseUtils()),
    ChangeNotifierProvider<LocalBooksController>(
        create: (_) => LocalBooksController()),
    ChangeNotifierProvider<TabletUIController>(
        create: (_) => TabletUIController()),
  ], child: MyMaterialApp()));
}
                  ...
                  appBar: AppBar(
                    ...
                    systemOverlayStyle: SystemUiOverlayStyle(
                        systemNavigationBarColor:
                            c.isLightMode ? Colors.black : Colors.white),
                  ),
                  body: Stack(children: [
                    [
    ...
    GoRoute(
        ...
        routes: [
          ...
          GoRoute(
              path: 'terms',
              builder: (context, state) =>
                  MarkdownScreen(data: termsOfService)),
          GoRoute(
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (context, state) {
                    ...
                    return AuthGate(
                        isSignedInChild: ScreenAdapter(bookId: bookId),
                        isNotSignedInChild:
                            SignInScreen(child: ScreenAdapter(bookId: bookId)));
                  },
                ),
                GoRoute(
                    path: "query",
                    ...
                    routes: [
                      GoRoute(
                          ...
                          builder: (context, state) {
                            return AuthGate(
                                isSignedInChild:
                                    GenreIndexScreen(currentGenre: "Novels"),
                                isNotSignedInChild: SignInScreen(
                                    child: GenreIndexScreen(
                                        currentGenre: "Novels")));
                          },
                          routes: [
                            GoRoute(
                              ...
                              builder: (context, state) {
                                String subCategory =
                                    state.pathParameters["subCategory"] ?? "";

                                return AuthGate(
                                    isSignedInChild: page(context, "Novels",
                                        subCategory.toCapitalized),
                                    isNotSignedInChild: SignInScreen(
                                        child: page(context, "Novels",
                                            subCategory.toCapitalized)));
                              },
                            )
                          ])
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (context, state) {
                    ...
                    return AuthGate(
                        isSignedInChild: StoryScreenAdapter(storyId: storyId),
                        isNotSignedInChild:
                            StoryScreenAdapter(storyId: storyId));
          ...
          GoRoute(
            ...
            builder: (context, state) {
              return AuthGate(
                  isSignedInChild: CreatorIndexScreen(),
                  isNotSignedInChild:
                      SignInScreen(child: CreatorIndexScreen()));
