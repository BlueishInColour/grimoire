...
class CreateUserController extends MainController{
  ...
  fetchUser()async{
      //
      // User user = await userRepo.getOneUser(isCompleted: (){},
  ...
  captureProfilePicture(BuildContext context)async {
   //
   ...
   //
   // Uint8List uint8list = await  Navigator.push(context, MaterialPageRoute(builder: (context)=>TakePictureScreen(camera: firstCamera)));
   //  uploadListOfImage(medias: [uint8list]
   //      ,
