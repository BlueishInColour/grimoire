...
class _BookDetailScreenState extends State<BookDetailScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Widget boxbox({required Widget text ,required IconData icon,required String title, required Color iconColor}){
      return Padding(
        padding: const EdgeInsets.all(8.0),
        child: Container(
          padding: const EdgeInsets.all(8.0),
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          SizedBox(height: 10,),
                          Text(book.title,style: GoogleFonts.crimsonPro(
                            fontSize: 25,
                      ...
                      Row(
                        ...
                        children: [
                          boxbox(
                            iconColor:colorRed,
                              text: likesCount(context, widget.book.bookId,),
                            icon: Icons.favorite,
                            title: "Likes"
                          ),
                          boxbox(
                            ...
                            text:Text((book.timeSpentInMilliSeconds /3.6e+6).round().abbreviate() +"hrs"   ,style: countStyle,),
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          ...book.subCategory.map((v){return box(text: v,color: Colors.grey.shade100);})
                        ],
                      ),
                      ...
                      Row(
                        ...
                        Text(book.aboutBook,style: GoogleFonts.crimsonText(
                          fontSize: 16
                        ),)
                    ],
                  ),
          ...
          Expanded(
            child: OutlinedButton.icon(
              style: ButtonStyle(
                ...
                side: WidgetStatePropertyAll(BorderSide(color: colorRed,
                width: 2)),
                ...
                icon: Text("Play",style: GoogleFonts.montserrat(
                  fontWeight: FontWeight.w900,
                  color: colorRed,
                ),),
                label: Icon(Icons.play_arrow,color: colorRed,)
            ),
          ),
   SizedBox(width: 15,),
   IconButton(
       style: ButtonStyle(
         shape: WidgetStatePropertyAll(CircleBorder(side: BorderSide(color: Colors.black87,width: 2)))
       ),
       onPressed: (){
